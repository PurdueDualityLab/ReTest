...
UnicodeLeadSurrogate
    // Surrogates are not valid standalone Unicode; using placeholder range
    : [\u0100-\u017F]  // Latin Extended-A as surrogate placeholder
    ;
...
UnicodeTrailSurrogate
    // Surrogates are not valid standalone Unicode; using placeholder range
    : [\u0180-\u024F]  // Latin Extended-B as surrogate placeholder
    ;
